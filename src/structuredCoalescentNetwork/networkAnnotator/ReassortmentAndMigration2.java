 ...
 */
public class ReassortmentAndMigration2 extends ReassortmentAnnotator {
	...
	Double sumRatesForward;
	Double sumRatesBackward;
	...
	public ReassortmentAndMigration2(NetworkAnnotatorOptions options) throws IOException {
	...
	private void assignMigrationNodes(NetworkNode migNode, double threshold) {
