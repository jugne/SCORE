...
/**
 * Taken from CoalRe package by N. F. Muller et al.
 * 
 * Adapted to work on structured networks by Ugne Stolz
 */
    ...
    public void printToFile(File outFile) throws FileNotFoundException{
        try (PrintStream ps = new PrintStream(outFile)) {
        	...
        	for (BitSetArray key : reassortmentCladeMap.keySet()){
				...
				List<Object> rawHeights = reassortmentCladeMap.get(key).attributeValues.get("height");
