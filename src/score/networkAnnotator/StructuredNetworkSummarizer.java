...
/**
 * A rewrite of TreeAnnotator targeted at summarizing ACG logs generated by
 * SCoRe.
 * 
 * Original code by
 * 
 ...
 */
public class StructuredNetworkSummarizer extends SCoReAnnotator {
    ...
    public StructuredNetworkSummarizer(NetworkAnnotatorOptions options) throws IOException {
    ...
    private static boolean getOptionsGUI(NetworkAnnotatorOptions options) {
		...
		dialog.setTitle("Structured Reassortment Network Annotator");
    ...
    private static void setupGUIOutput() {
		...
		frame.setTitle("Structured Reassortment Network Annotator");
    ...
    public static void main(String[] args) {
        ...
        // Run ACGAnnotator
        try {
            new StructuredNetworkSummarizer(options);
	...
	private void removeMigrationNodes(Network network) {
